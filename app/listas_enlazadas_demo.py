...
from .listas_enlazadas import RetoLista

class ListasEnlazadasDemo(tk.Frame):
    def __init__(self, master):
        super().__init__(master)
        
        # Título y descripción
        tk.Label(self, text="Demo: Gestión de lista de características (features)", 
                font=("Arial", 12, "bold")).grid(row=0, column=0, columnspan=3, pady=5)
        
        desc = ("Gestiona una lista enlazada de características pendientes.\n"
                "Comandos: PUSH_FRONT <nombre>, PUSH_BACK <nombre>, POP_FRONT, END.")
        ...
        self.txt_commands.insert("1.0", "PUSH_FRONT F1\nPUSH_BACK F2\nPOP_FRONT\nPOP_FRONT\nEND")
