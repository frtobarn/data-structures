...
from .pilas import RetoPila

class PilasDemo(tk.Frame):
    def __init__(self, master):
        super().__init__(master)
        
        # Título y descripción
        tk.Label(self, text="Demo: Editor de texto con deshacer (Pilas)", 
                font=("Arial", 12, "bold")).grid(row=0, column=0, columnspan=3, pady=5)
        
        desc = ("Simula un editor de texto con funcionalidad de deshacer.\n"
                "Comandos: PUSH <acción>, POP, END.")
        ...
        self.txt_commands.insert("1.0", "PUSH Escribir Hola\nPUSH Borrar Hola\nPOP\nPOP\nPOP\nEND")
        ...
        test_cases = [
            ("Ejemplo 1", "PUSH Escribir Hola\nPUSH Borrar Hola\nPOP\nPOP\nPOP\nEND"),
            ("Ejemplo 2", "POP\nPUSH Pegar imagen\nPOP\nEND"),
            ("Ejemplo 3", "PUSH Cortar párrafo\nPUSH Escribir título\nPUSH Pegar párrafo\nPOP\nPOP\nEND")
        ]
