...
from .colas import RetoCola

class ColasDemo(tk.Frame):
    def __init__(self, master):
        super().__init__(master)
        
        # Título y descripción
        tk.Label(self, text="Demo: Atención de pacientes en orden (Colas)", 
                font=("Arial", 12, "bold")).grid(row=0, column=0, columnspan=3, pady=5)
        
        desc = ("Simula la atención de pacientes en un hospital por orden de llegada.\n"
                "Comandos: ENQUEUE <nombre>, DEQUEUE, END.")
        ...
        self.txt_commands.insert("1.0", "ENQUEUE Juan\nENQUEUE María\nDEQUEUE\nDEQUEUE\nDEQUEUE\nEND")
        ...
        test_cases = [
            ("Ejemplo 1", "ENQUEUE Juan\nENQUEUE María\nDEQUEUE\nDEQUEUE\nDEQUEUE\nEND"),
            ("Ejemplo 2", "DEQUEUE\nENQUEUE Laura\nDEQUEUE\nEND"),
            ("Ejemplo 3", "ENQUEUE Ana\nENQUEUE Luis\nENQUEUE Tomás\nDEQUEUE\nDEQUEUE\nEND")
        ]
