...
class ArbolBinarioBusqueda:
    ...
    def delete(self, key):
        ...
        return initial_root is not None and self.root!= initial_root or (self.root is None and initial_root is not None) # Simple check if root changed or was deleted
        ...
        while True:
            try:
                ...
                if command == "INSERT":
                    ...
                    if self.search(key): # Check existence before attempting delete
                        self.delete(key)
                        print("ELIMINADO")
                        print(self.in_order_traversal())
                    else:
                        print("ID NO ENCONTRADO")
                        print(self.in_order_traversal()) # Still print traversal as per requirements
